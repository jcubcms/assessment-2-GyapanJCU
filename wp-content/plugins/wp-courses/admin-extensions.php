<div class="wpc-admin-section">
    <h1 class="wpc-admin-h1">Add-Ons</h1>
    <div class="wpc-admin-box-wrapper">
        <div class="wpc-admin-box wpc-4">
            ...
            <a href="https://wpcoursesplugin.com/wp-courses-premium/" class="button">Learn More</a>
        </div>
    	<div class="wpc-admin-box wpc-4">
    ...
    <div class="wpc-admin-box-wrapper">
        <div class="wpc-admin-box wpc-4">
            <h2 class="wpc-admin-box-header">Lesson Clones</h2>
            <div class="wpc-video-wrapper">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/JB5un93nm-U" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
            <p>Create lesson clones which use the same content and tracking data as another lesson. This allows for the use of lessons across multiple courses without having to duplicate lesson content.</p>
            <a href="https://wpcoursesplugin.com/wp-courses-premium/" class="button">Learn More</a>
        </div>
        <div class="wpc-admin-box wpc-4" style="display: none;"></div>
        <div class="wpc-admin-box wpc-4" style="display: none;"></div>
    </div>
</div>